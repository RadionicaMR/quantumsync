...
const translations: Record<Language, Record<string, string>> = {
  es: {
    ...
    'auth.whatsappHelp': 'Ingresa tu WhatsApp con código de país para recibir soporte personalizado.',
    'auth.whatsappInvalid': 'Ingresa un número de WhatsApp válido con código de país.',
  ...
  en: {
    ...
    'auth.whatsapp': 'WhatsApp',
    'auth.whatsappHelp': 'Enter your WhatsApp number with country code to receive personalized support.',
    'auth.whatsappInvalid': 'Please enter a valid WhatsApp number with country code.',
