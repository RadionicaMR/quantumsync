...
const Footer = () => {
  return (
    <footer className="w-full py-8 px-4 md:px-6 bg-white/80 dark:bg-card/80 backdrop-blur-lg border-t border-border mt-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="flex items-center gap-2 mb-4">
              <div className="relative w-8 h-8">
                ...
                <div className="absolute inset-1 bg-white dark:bg-card rounded-full flex items-center justify-center">
                  <span className="text-quantum-primary font-bold text-sm">Q</span>
                </div>
              </div>
              <span className="text-lg font-bold bg-clip-text text-transparent bg-quantum-gradient">
                QuantumSync
              </span>
            </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link to="/manifestation" className="text-sm text-muted-foreground hover:text-primary transition-colors">
                  Manifestación de Metas
                </Link>
              </li>
              <li>
                <Link to="/balance-chakras" className="text-sm text-muted-foreground hover:text-primary transition-colors">
                  Balance de Chakras
                </Link>
              </li>
            </ul>
