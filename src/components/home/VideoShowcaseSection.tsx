      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        >
          ...
          <div className="relative">
            <div className="relative w-[200px] md:w-[220px] lg:w-[250px] bg-gradient-to-b from-gray-800 to-gray-900 rounded-[2.5rem] p-2 shadow-[0_0_60px_rgba(168,85,247,0.3)]">
              ...
              <div className="relative bg-black rounded-[2rem] overflow-hidden">
                <div className="aspect-[9/19] bg-black overflow-hidden">
                  <iframe
