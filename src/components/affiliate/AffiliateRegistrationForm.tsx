...
import { AlertCircle, UserPlus, Mail, Lock, User, Phone, Globe } from 'lucide-react';
import { AffiliateRegistrationForm as FormData } from '@/types/affiliate';

interface AffiliateRegistrationFormProps {
  onSubmit: (formData: FormData & { confirmPassword: string }) => void;
  loading: boolean;
  error: string;
}

const AffiliateRegistrationForm = ({ onSubmit, loading, error }: AffiliateRegistrationFormProps) => {
